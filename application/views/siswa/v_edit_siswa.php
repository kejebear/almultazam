        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Data Induk Siswa</h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
              </div>
            </div>
             <form role="form" action="<?php echo base_url('siswa/save_editsiswa'); ?>" method="post">
            <div class="box-body">
              <!--- Batas Atas Tab-->
                ...
                <div class="tab-content no-padding">
                  ...
                  <div class="chart tab-pane active" id="dsiswa" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>NIS<input type="text" name="nis" value="<?php echo $r->nis;  ?>" class="form-control" size="10" readonly/></label>
                    </div>
                    <div class="form-group"><label>NISN
                      <input type="text" name="nisn" value="<?php echo $r->nisn;  ?>" class="form-control" size="10" placeholder="Isi NISN"/></label>
                    </div>
                    <div class="form-group"><label>Nama Lengkap
                      <input type="text" class="form-control" value="<?php echo $r->nama_lengkap;  ?>" name="nama_lengkap" size="70"  placeholder="Isi Nama Lengkap"/></label>
                    </div>
                    <div class="form-group"><label>Nama Panggilan
                      <input type="text" class="form-control" name="nama_panggilan" value="<?php echo $r->nama_panggilan;  ?>" size="30" placeholder="Isi Nama Panggilan"/></label>
                    </div>
                    ...
                    <div class="form-group">
                      <label>Tempat Lahir</label><input type="text" value="<?php echo $r->tempat_lahir;  ?>" name="tempat_lahir" class="form-control" size="10" /> 
                    </div>
                    <div class="form-group">
                       <label>Tanggal Lahir</label>
                             <input type="date" name="tanggal_lahir" value="<?php echo $r->tanggal_lahir;  ?>" class="form-control" size="10" /> 
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      <label>Anak Ke- <input type="text" name="anake" maxlegth="10" value="<?php echo $r->anak_ke;  ?>"  class="form-control" size="10" /></label>
                    </div>
                    <div class="form-group">
                      <label>Jumlah Saudara Kandung <input type="text" maxlegth="10" value="<?php echo $r->sdr_kandung;  ?>" name="saudara_kandung"  class="form-control" size="10" /></label>
                    </div>
                    <div class="form-group">
                      <label>Jumlah Saudara Tiri <input type="text" maxlegth="10" value="<?php echo $r->sdr_tiri;  ?>" name="saudara_tiri"  class="form-control" size="10" /></label>
                    </div>
                    <div class="form-group">
                      <label>Jumlah Saudara Angkat <input type="text" maxlegth="10" value="<?php echo $r->sdr_angkat;  ?>" name="saudara_angkat"  class="form-control" size="10" /></label>
                    </div>


                   <div class="form-group">
                      <label for="exampleInputFile">Foto Siswa:</label>
                    <img src="<?php echo base_url();?>assets/gambar_siswa/siswa_sma/<?php echo $r->foto; ?>">
                      <input type="file" id="fotosiswa" name="fotosiswa">
                     
                   </div>
                   <div class="form-group">
                      <label>Email<input type="text" name="email" value="<?php echo $r->email;  ?>" class="form-control" size="10" /></label>
                    </div>
                    <div class="form-group">
                      <label>Bahasa Sehari-hari</label>
                              <textarea class="form-control" name="bahasa" value="<?php echo $r->bahasa;  ?>" rows="3" placeholder="Isi Bahasa Sehari-hari yang digunakan..."></textarea>
                    </div>
                   ...
                   <div class="form-group">
                      <label>Mulai Belajar Disini Tanggal : <input type="date" maxlegth="10" name="tanggal_masuk"  value="<?php echo $r->tgl_masuk;  ?>" class="form-control" size="10" /></label>
                    </div>
            ...
            <!---Tab Kedua Berisi Form Alamat-->
                  <div class="chart tab-pane" id="dalamat" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>RT/RW</label>
                            <input type="text" name="rt" value="<?php echo $r->rt_asal;  ?>" class="form-control" maxlegth="10" placeholder="isi RT" />
                    </div>
                     <div class="form-group">
                        <label>RW</label>
                          <input type="text" name="rw" class="form-control" value="<?php echo $r->rw_asal;  ?>" maxlegth="10" placeholder="isi RW" />
                    </div>
                    <div class="form-group">
                        <label>Jalan</label>
                         <input type="text" name="jln" class="form-control" value="<?php echo $r->jalan_asal;  ?>" maxlegth="10" placeholder="isi Jalan" />
                    </div>
                    <div class="form-group">
                        <label>Desa/Kelurahan</label>
                         <input type="text" name="desa" class="form-control" maxlegth="50" value="<?php echo $r->desa_asal;  ?>" placeholder="isi Desa" />
                    </div>
                    <div class="form-group">
                        <label>Kecamatan</label>
                         <input type="text" name="kec" class="form-control" maxlegth="50" value="<?php echo $r->kec_asal;  ?>" placeholder="isi Kecamatan" />
                    </div>
                    <div class="form-group">
                        <label>Kabupaten</label>
                         <input type="text" name="kab" class="form-control" maxlegth="20" value="<?php echo $r->kab_asal;  ?>" placeholder="isi Kabupaten" />
                    </div>
                    <div class="form-group">
                        <label>Provinsi</label>
                         <input type="text" name="prov" class="form-control" maxlegth="20" value="<?php echo $r->provinsi_asal;  ?>" placeholder="isi Provinsi" />
                    </div>
                    <div class="form-group">
                        <label>Jarak Ke Sekolah
                         <input type="text" name="jarak" class="form-control"  value="<?php echo $r->jarak_asal;  ?>" maxlegth="10" placeholder="isi Jarak" /></label>
                    </div>
                     <div class="form-group">
                        <label>Sarana Transportasi</label>
                         <input type="text" name="sarana" class="form-control" value="<?php echo $r->transport_asal;  ?>" maxlegth="10" placeholder="isi Sarana Transportasi.." />
                    </div>
                  </div>
...
<!---Tab Ketiga Berisi Form Tinggal-->
                  <div class="chart tab-pane" id="dalamattgl" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>RT/RW</label>
                            <input type="text" name="rttgl" value="<?php echo $r->rt;  ?>" class="form-control"  maxlegth="10" placeholder="isi RT" />
                    </div>
                     <div class="form-group">
                        <label>RW</label>
                          <input type="text" name="rwtgl" value="<?php echo $r->rw;  ?>" class="form-control" maxlegth="10" placeholder="isi RW" />
                    </div>
                    <div class="form-group">
                        <label>Jalan</label>
                          <input type="text" name="jlntgl" value="<?php echo $r->jalan;  ?>" class="form-control" maxlegth="10" placeholder="isi Jalan" />
                    </div>
                    <div class="form-group">
                        <label>Desa/Kelurahan</label>
                         <input type="text" name="desatgl" value="<?php echo $r->desa;  ?>" class="form-control" maxlegth="10" placeholder="isi Desa" />
                    </div>
                    <div class="form-group">
                        <label>Kecamatan</label>
                         <input type="text" name="kectgl" value="<?php echo $r->kec;  ?>" class="form-control" maxlegth="10" placeholder="isi Kecamatan" />
                    </div>
                    <div class="form-group">
                        <label>Kabupaten</label>
                         <input type="text" name="kabtgl" value="<?php echo $r->kab;  ?>" class="form-control" maxlegth="20" placeholder="isi Kabupaten" />
                    </div>
                    <div class="form-group">
                        <label>No.Telp</label>
                         <input type="text" name="telptgl" value="<?php echo $r->telepon;  ?>" class="form-control" maxlegth="10" placeholder="isi No.Telp" />
                    </div>
                    <div class="form-group">
                        <label>Jarak Ke Sekolah
                         <input type="text" name="jaraktgl" class="form-control" value="<?php echo $r->jarak;  ?>" maxlegth="10" placeholder="isi Jarak" /></label>
                    </div>
                     <div class="form-group">
                        <label>Sarana Transportasi</label>
                         <input type="text" name="saranatgl" class="form-control" value="<?php echo $r->transport;  ?>" maxlegth="10" placeholder="isi Sarana Transportasi.." />
                    </div>
                  </div>
<?php
                  ...
                  <div class="chart tab-pane" id="dkesehatan" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>Golongan Darah</label>
                            <input type="text" name="goldar"  value="<?php echo $r->golongan_darah;  ?>" class="form-control" maxlegth="10" placeholder="isi Golongan Darah" />
                    </div>
                     <div class="form-group">
                        <label>Penyakit Kronis Yang Penah Diderita</label>
                          <input type="text" name="penyakit" value="<?php echo $r->penyakit;  ?>" class="form-control" placeholder="isi Penyakit, Jika Ada.." />
                    </div>
                    <div class="form-group">
                        <label>Kelainan</label>
                         <input type="text" name="kelainan" value="<?php echo $r->kelainan;  ?>" class="form-control" maxlegth="10" placeholder="isi Kelainan,Jika Ada..." />
                    </div>
                    <div class="form-group">
                        <label>Tinggi Badan
                         <input type="text" name="tb" value="<?php echo $r->tinggi_badan;  ?>" class="form-control" maxlegth="10" placeholder="isi Tinggi Badan" /> Cm</label>
                    </div>
                    <div class="form-group">
                        <label>Berat Badan</label>
                         <input type="text" name="bb" value="<?php echo $r->berat_darah;  ?>" class="form-control" placeholder="isi Berat Badan" /> Kg
                    </div>
                  </div>
            <?php
            }
...
<!---Tab Keenam Berisi Form Riwayat Ibu-->
              <div class="chart tab-pane" id="dibu" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>No. Telepon</label>
                            <input type="text" name="no_telp_ibu" class="form-control" maxlegth="50" placeholder="isi Desa " />
                    </div>
                     <div class="form-group">
                          <label>Provinsi </label>
              ...
              <div class="chart tab-pane" id="dhobi" style="position: relative;">
                    ...
                    <div class="form-group">
                      <label>Kegemaran Seni</label>
                              <textarea class="form-control" name="hobiseni" value="<?php echo $r->seni;  ?>" rows="3" placeholder="Isi Hobi Kesenian..."></textarea>
                    </div>
                    <div class="form-group">
                      <label>Kegemaran Olahraga</label>
                              <textarea class="form-control" name="hobiolahraga" value="<?php echo $r->olahraga;  ?>" rows="3" placeholder="Isi Hobi Olahraga..."></textarea>
                    </div>
                    <div class="form-group">
                           <label>Organisasi</label>
                              <textarea class="form-control" name="hobiorganiasi" value="<?php echo $r->organisasi;  ?>" rows="3" placeholder="Isi Organisasi Yang Diikuti..."></textarea>
                    </div>
                     <div class="form-group">
                           <label>Lainnya</label>
                              <textarea class="form-control" name="hobilainnya" value="<?php echo $r->lainnya;  ?>" rows="3" placeholder="Isi Organisasi Yang Diikuti..."></textarea>
                    </div>
             </div>
