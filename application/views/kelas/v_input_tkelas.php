        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Input Tingkatan Kelas</h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
              </div>
            </div>
             <form role="form" action="<?php echo base_url('kelas/tambahtkelas'); ?>" method="post">
            <div class="box-body">
              <!--- Batas Atas Tab-->
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#dsekolah" data-toggle="tab">Data Tingkatan Kelas</a></li>
                ...
                <div class="tab-content no-padding">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      ...
                      <label>Kelas</label><input type="text" name="nama_kelas" class="form-control" size="50" placeholder="Isi Dengan Angka Romawi. Contoh : I untuk kelas 1,dll" />
